...
$user="root";
$db_name="kshaktriya";
$con= mysqli_connect ($host, $user, $password,$db_name) or die('Not connected : Ah sh*t ' . mysqli_connect_error());
...
if (isset($_POST['login'])) {
    ...
    if($sqlrun=$con->query($sql)){
        ...
        echo "<script>alert('Your Account it');</script>";
    }
...
if (isset($_POST['signup'])) {
   ...
   $sql="INSERT INTO adminlogin(admin_reg_no , admin_name ,admin_number,admin_email,pwd,admin_image) VALUES ('$regno','$name','$number','$email','$pwd','$image')";
